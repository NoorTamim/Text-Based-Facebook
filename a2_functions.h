 ...
 *
 * Purpose: Declares functions for managing users, friends, and posts
 *          in a text-based social network application.
 */
...
/* 
   ...
   The value entered by the user must be from 1 to n.
